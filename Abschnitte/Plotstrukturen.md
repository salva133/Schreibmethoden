# Planungsmethoden & Plotstrukturen
...
**Quelle:** Randy Ingermanson, *How to Write a Novel Using the Snowflake Method* (2014); ingermanson.com
...
*Klassische Dramaturgie seit Aristoteles*

Die einfachste und robusteste Plotstruktur:
...
## Das W-Fragen-Modell (Plotting mit Kernfragen)

Vor dem Schreiben diese Fragen beantworten:

- **WER** ist der Protagonist? Was will er? Was fürchtet er?
- **WAS** steht auf dem Spiel? (innerer & äußerer Konflikt)
- **WARUM** jetzt? Was hat die Geschichte ausgelöst?
- **WIE** versucht der Held sein Ziel zu erreichen?
- **WOMIT** scheitert er? Welche Hindernisse?
- **WOHIN** führt der Weg? Was ist die Aussage der Geschichte?

---

## Pantsing vs. Plotting

| Methode | Beschreibung | Berühmte Vertreter |
|---------|-------------|-------------------|
| **Plotting** (Plotter) | Detaillierter Plan vor dem Schreiben | J.K. Rowling, Randy Ingermanson |
| **Pantsing** (Pantser) | Intuitiv „aus dem Bauch heraus" schreiben | Stephen King, George R.R. Martin (früher) |
| **Plantser** | Grobe Struktur + intuitives Schreiben | Viele erfolgreiche Autoren |
...
1. **Spiegel-Midpoint.** Eine Szene, die den Anfang gespiegelt zeigt. Die gleiche Situation, aber der Held kann nicht mehr derselbe sein. Sichtbarmachen der bisherigen Veränderung.
2. **False Victory.** Der Held glaubt, gewonnen zu haben. Die Falle: Was er gewonnen hat, war nicht das Richtige. Ab hier kippt der Plot.
3. **False Defeat.** Der Held glaubt, alles verloren zu haben. Aus dem Boden steht er anders auf, mit neuem Wissen, neuer Entschlossenheit, oft neuer Identität.

Der Midpoint trennt die reaktive von der proaktiven Phase: Vorher reagiert der Held, danach handelt er. Diese Verschiebung ist der eigentliche Inhalt des Bogens.

*Quelle: Michael Hauge, Writing Screenplays That Sell (1988); Save the Cat-Tradition, Blake Snyder*
...
Ein Roman ohne Subplots ist eine Skizze. Subplots geben der Welt Tiefe, dem Protagonisten Spiegelflächen und dem Tempo Variation.

**Verbindung zum Hauptplot.** Ein Subplot, der nichts mit dem Hauptplot zu tun hat, ist eine zweite Geschichte im selben Buch. Verbindung kann sein: thematisch (gleiche Frage, andere Antwort), figural (eine Nebenfigur, deren Entscheidung den Protagonisten zwingt) oder kausal (Subplot-Ereignis wird Plot-Hebel).
...
**Sparsam einführen.** Drei Subplots reichen für die meisten Romane. Mehr verwässern den Hauptplot.
...
- **Setup vor Payoff, immer.** Ein Element, das erst beim Einsatz erklärt wird, ist Deus ex Machina.
- **Setup zweimal, nicht dreimal.** Einmal kann der Leser übersehen, zweimal merkt er es. Dreimal ist Manipulation, der Leser sieht den Payoff kommen.
- **Falsche Payoffs einstreuen.** Nicht jedes Setup muss eingelöst werden. Manche Setups sind reines Welt-Detail. Ein Roman, in dem jedes Element Funktion hat, wirkt mechanisch.

**Inverses Prinzip.** Wenn ein dramatischer Moment im Plot ungesetzt wirkt, fehlt meist das Setup vorher, nicht der Moment selbst.
