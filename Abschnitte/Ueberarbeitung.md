...
| Durchgang | Fokus |
|-----------|-------|
| **1. Makro-Lektorat** | Struktur, Plot, Figurenbögen, Pacing, fehlende Szenen |
| **2. Szenen-Lektorat** | Jede Szene: Ziel? Konflikt? Veränderung? Notwendig? |
| **3. Stil-Lektorat** | Satzrhythmus, Wortwahl, Redundanzen, Stärke der Verben |
| **4. Korrektur** | Rechtschreibung, Grammatik, Interpunktion |
...
Faustregel: Eine Szene ohne Konflikt oder ohne Ergebnis ist keine Szene, sondern Übergang. Übergänge gehören gerafft, nicht ausgespielt.
...
| Draft | Fokus |
|-------|-------|
| **1. Erstentwurf** | Existieren lassen. Tempo, keine Eitelkeit. |
| **2. Charakter-Pass** | Nur Figuren prüfen. Stimmen sie? Wachsen sie? Voice konsistent? |
| **3. Setting-Pass** | Welt, Sinneseindrücke, Konsistenz von Orten und Regeln. |
| **4. Plot-Pass** | Setup-Payoff, Pinch Points, Subplot-Verbindungen. |
...
Anwendungsfälle: Darstellung von Krankheit, Behinderung, Migration, religiöser Praxis, ethnischer Identität, Trauma, Berufsmilieus, in denen man nicht selbst gearbeitet hat.

Sensitivity Reading ersetzt keine Recherche. Es prüft, ob die Recherche in Prosa ankommt, oder ob Klischees, Auslassungen und falsche Töne stehengeblieben sind.
